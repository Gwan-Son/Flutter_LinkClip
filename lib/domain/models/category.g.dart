...
const CategorySchema = CollectionSchema(
  ...
  idName: r'id',
  indexes: {
    r'colorValue': IndexSchema(
      id: -5424716062542782806,
      name: r'colorValue',
      unique: false,
      replace: false,
      properties: [
...
extension CategoryQueryWhereSort on QueryBuilder<Category, Category, QWhere> {
  ...
  QueryBuilder<Category, Category, QAfterWhere> anyColorValue() {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
        const IndexWhereClause.any(indexName: r'colorValue'),
      );
    });
  }
}
...
extension CategoryQueryWhere on QueryBuilder<Category, Category, QWhereClause> {
  ...
  QueryBuilder<Category, Category, QAfterWhereClause> colorValueEqualTo(
      int colorValue) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
        indexName: r'colorValue',
        value: [colorValue],
      ));
    });
  }

  QueryBuilder<Category, Category, QAfterWhereClause> colorValueNotEqualTo(
      int colorValue) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
  ...
  QueryBuilder<Category, Category, QAfterWhereClause> colorValueGreaterThan(
    int colorValue, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Category, Category, QAfterWhereClause> colorValueLessThan(
    int colorValue, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Category, Category, QAfterWhereClause> colorValueBetween(
    int lowerColorValue,
    int upperColorValue, {
    bool includeLower = true,
    bool includeUpper = true,
    ...
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.between(
        indexName: r'colorValue',
        lower: [lowerColorValue],
        includeLower: includeLower,
        upper: [upperColorValue],
        includeUpper: includeUpper,
      ));
    });
  }
